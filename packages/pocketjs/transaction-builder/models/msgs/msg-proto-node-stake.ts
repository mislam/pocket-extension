...
export class MsgProtoNodeStakeTx extends TxMsg {
    ...
    */
   constructor(pubKey: string, chains: string[], amount: string, serviceURL: URL) {
      super()
      ...
      if (isNaN(amountNumber)) {
         ...
         throw new Error(`Amount below minimum stake amount (${MINIMUM_STAKE_AMOUNT})`)
   ...
   private getParsedServiceURL(): string {
      return `${this.serviceURL.protocol ? this.serviceURL.protocol : this.DEFAULT_PROTOCOL}//${
