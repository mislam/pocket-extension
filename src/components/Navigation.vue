...
<template>
   <div v-if="finishedOnboarding && unlocked">
      ...
      <!-- Footer -->
      <div class="tabs">
         <div @click="goto('Dashboard')" class="tabs-item" :class="{ active: 'Dashboard' === currentRoute }">
         ...
         <div @click="goto('History')" class="tabs-item" :class="{ active: 'History' === currentRoute }">
            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
         ...
         <div @click="goto('Settings')" class="tabs-item" :class="{ active: 'Settings' === currentRoute }">
            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
               <path
